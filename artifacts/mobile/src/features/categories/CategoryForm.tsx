...
export function CategoryForm({ initialData, onSubmit, onCancel }: CategoryFormProps) {
  ...
  const onFormSubmit = (data: FormData) => {
    ...
    onSubmit({ name: data.name, icon, color, type });
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <ThemedText variant="subtitle">{initialData?.id ? 'Editar categoria' : 'Nova categoria'}</ThemedText>
      ...
      <View style={styles.form}>
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <FormInput label="Nome" value={value} onChangeText={onChange} placeholder="Ex: Alimentação" error={errors.name?.message} />
          )}
        />
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Pressable
                ...
                onPress={() => { setIcon(item); setShowIconModal(false); }}
              >
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Pressable
                ...
                onPress={() => { setColor(item); setShowColorModal(false); }}
              >
